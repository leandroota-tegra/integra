...
export function Hero() {
    ...
    return (
        <section ref={containerRef} className="relative min-h-[75vh] w-full flex items-center bg-brand overflow-hidden pt-32 pb-20 md:pt-0 md:pb-0">
            ...
            <div className="container px-4 md:px-6 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center h-full">
                ...
                <motion.div
                    style={{ y: yText }}
                    className="text-center md:text-left max-w-2xl mx-auto md:mx-0 group"
